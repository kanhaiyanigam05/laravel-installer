...
Route::group(['prefix' => 'install', 'as' => 'LaravelInstaller::', 'namespace' => 'Kanhaiyanigam05\LaravelInstaller\Controllers', 'middleware' => ['web', 'install']], function () {
    Route::get('/', [
        'as' => 'welcome',
...
Route::group(['prefix' => 'update', 'as' => 'LaravelUpdater::', 'namespace' => 'Kanhaiyanigam05\LaravelInstaller\Controllers', 'middleware' => 'web'], function () {
